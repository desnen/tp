...
public class UniquePersonList implements Iterable<Person> {
    ...
    /**
     * Returns true if the list contains another person with the same phone number as the given argument.
     */
    ...
    /**
     * Returns true if the list contains another person with the same email as the given argument.
     */
