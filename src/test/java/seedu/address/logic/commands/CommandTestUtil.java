...
public class CommandTestUtil {
    ...
    public static final String INVALID_EMAIL_DESC = "bob!yahoo"; // missing '@' symbol
    public static final String INVALID_GROUP_DESC = " "; // empty string not allowed for group
